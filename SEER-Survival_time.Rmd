...
#GUA
 ```{r}
data <- read.csv("seer_data_full.csv")
# xgboost(binary)

# preprocessing
data <- select(data,-c(1,2,27,45,40,29))
anumeric <- data[,c(3,7,8,9,10,11,12,13)]
afactor <- data[,-c(3,7,8,9,10,11,12,13)]
